...
class test(unittest.TestCase):
    ...
    def test_(self):
        ...
        driver.find_element_by_link_text(u"理由设置").click()
        driver.find_element_by_css_selector("span.icon-plus").click()
        driver.find_element_by_xpath("(//input[@name='content'])[3]").click()
        driver.find_element_by_xpath("(//input[@name='content'])[3]").clear()
        driver.find_element_by_xpath("(//input[@name='content'])[3]").send_keys(u"哇咔咔咔咔咔咔咔")
        driver.find_element_by_id("orderConfigSaveBtn").click()
